      ...
      <div className="segment game-segment">
        <div className="content">
          ...
          <div className="preview">
            ...
            <FsLightbox
              toggler={lightboxController.toggler}
              sources={['./screen_01.webp', './screen_02.webp', './screen_03.webp']}
        ...
        <div className="content">
          ...
          <div className="social-icons">
            <a href="https://headkino.itch.io/" target="_blank" rel="noopener noreferrer">
              <img
                src="/itchio-black-no-text.webp"
                alt="Itch.io"
                className="social-icon itch"
              />
            </a>
            <a
            ...
            <a
              href="https://threads.net/@headkino.games"
              target="_blank"
              rel="noopener noreferrer"
            >
            ...
            <a
              href="https://www.linkedin.com/company/headkino"
              target="_blank"
              rel="noopener noreferrer"
            >
      ...
      <div id="team" className="segment about-us-segment">
        <div className="content">
          ...
          <p className="text-description">
            ...
            <br />
            <br />
            <span>HeadKino Games</span> is a game studio set to be established in Q2 of
            2025!
            <br />
            <br />
            Our first project <span>Haunted Cleaner</span> was born of a combination of
            cozy games and personal stories in mysterious, nostalgic settings. The project
            reflects a shared interest in unusual, cross-genre media and aims to create
            engaging experiences, emotional connection and relaxation through satisfying
            interactions and both direct and indirect storytelling.
            <br />
            <br />
            <Link to="/team">
