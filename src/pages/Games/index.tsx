        ...
        <>
            ...
            <main className="games-page">
                    ...
                    <div className="left-text-block">
                        <div className="game-desc">
                            <p className="game-lead">
                                <span className="game-title-name">HAUNTED CLEANER</span> is a
                                relaxing light puzzle and narrative game about tidying up and
                                decorating the rooms of the deceased and unpacking the stories
                                left behind. Play a psychic cleaner, meet diverse characters,
                                explore different locations, and help lost spirits find peace!
                            </p>
                    ...
                    <div className="right-bullet-points">
                        <ul>
                            <li>
                                ...
                                <br />
                                Meditative, Low pressure core experience, no “Lose States” or
                                “Game Overs” allowing the player to play at their own pace.
                            </li>
                            <li>
                                <strong>Self expression</strong>
                                <br />
                                Self expression through decoration, flexible puzzle solutions and
                                organisation systems, supporting unique and shareable
                                experiences.
                            </li>
                            <li>
                                <strong>Unique stories</strong>
                                <br />
                                Meet diverse characters, explore different locations, reveal
                                details of the story. Help lost spirits find peace
                            </li>
                            <li>
                                <strong>Aesthetically pleasing</strong>
                                <br />
                                A stylized, low-poly aesthetic across distinct settings,
                                including elements drawing from pre-2000s era, both nostalgic
                                and atmospheric.
                            </li>
                        </ul>
                    </div>
                ...
                <section className="centered-image-section">
                    ...
                    />
                    <p className="caption">
                        The player takes the role of Jones, a cleaner who can communicate
                        with the deceased. Throughout the game clients seek help in tidying
                        haunted locations and aiding trapped spirits to move on.
                    </p>
                </section>
